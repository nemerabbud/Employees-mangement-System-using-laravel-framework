...
<a href="<?php echo e(url('/Inbox')); ?>" class="notification">
    <span>Inbox</span>
          ...
          <div class="card-body p-3">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input value="" type="text" name="data[name]" class="form-control" id="name" placeholder="<?php echo e(Auth::user()->name); ?>" disabled>
              </div>
            </div>
            <div class="form-group">
              <label>Your email</label>
              <div class="input-group mb-2 mb-sm-0">
                <input type="email" value="" name="data[email]" class="form-control" id="email" placeholder="<?php echo e(Auth::user()->email); ?>" disabled>
              </div>
            </div>
            <div class="form-group">
              <label>Title</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\nemerabbud-pc\hexaEm\resources\views/contact.blade.php ENDPATH**/ ?>